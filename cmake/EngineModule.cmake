...
#
# WINDOWS_ONLY_HEADERS names a directory under include/, such as rhi/d3d12, whose
# headers name an API only Windows has. They are header-checked on Windows and
# left out elsewhere, where nothing could compile them.

function(engine_module target)
  cmake_parse_arguments(MODULE "" "WINDOWS_ONLY_HEADERS" "SOURCES;LINK_LIBRARIES" ${ARGN})
  ...
  if(MODULE_WINDOWS_ONLY_HEADERS AND NOT WIN32)
    list(FILTER module_headers EXCLUDE REGEX "/include/${MODULE_WINDOWS_ONLY_HEADERS}/")
  endif()
